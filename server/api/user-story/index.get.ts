...
import { UserStory, MoscowPriority, ReqType } from "~/domain/requirements/index.js"
...
export default defineEventHandler(async (event) => {
    ...
    return await findAllSolutionRequirements<UserStory>(ReqType.USER_STORY, em, query, ['primaryActor', 'outcome', 'functionalBehavior'])
})