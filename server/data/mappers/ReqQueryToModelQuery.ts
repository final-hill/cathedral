 ...
 */
export class ReqQueryToModelQuery implements Mapper<Partial<z.infer<typeof Requirement>>, Record<string, any>> {
    async map(query: Partial<z.infer<typeof Requirement>>): Promise<Record<string, any>> {
