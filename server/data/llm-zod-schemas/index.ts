...
export const llmRequirementSchema = z.object({
    ...
    priority: z.enum(MoscowPriority).describe(
    ...
    useCaseMainSuccessScenarioSteps: z.array(z.object({
        ...
        stepType: z.enum(ScenarioStepTypeEnum).describe('Whether this is an action or conditional branch'),
        actorName: z.string().nullable().describe('Name of the actor performing this step'),
        functionalBehaviorName: z.string().nullable().describe('Name of the functional behavior for this step')
    ...
    useCaseExtensionSteps: z.array(z.object({
        ...
        description: z.string().describe('Detailed step description'),
        stepType: z.enum(ScenarioStepTypeEnum).describe('Whether this is an action or conditional branch'),
        conditionNames: z.array(z.string()).nullable().describe('Condition names for conditional steps'),
        actorName: z.string().nullable().describe('Name of the actor performing this step'),
        functionalBehaviorName: z.string().nullable().describe('Name of the functional behavior for this step')
