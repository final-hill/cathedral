...
export const NonFunctionalBehavior = Functionality.extend({
    ...
    reqIdPrefix: z.literal('S.2.2.').prefault('S.2.2.'),
    reqType: z.enum(ReqType).prefault(ReqType.NON_FUNCTIONAL_BEHAVIOR),
    uiBasePathTemplate: z.string().prefault(uiBasePathTemplates[ReqType.NON_FUNCTIONAL_BEHAVIOR])
