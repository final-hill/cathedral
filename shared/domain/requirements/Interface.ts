...
export const Interface = Requirement.extend({
    ...
    reqIdPrefix: z.literal('S.3.').prefault('S.3.'),
    ...
    interfaceType: z.enum(InterfaceType).describe('Type of interface (API, CLI, or UI)'),
    operations: z.array(InterfaceOperationReference).prefault([])
