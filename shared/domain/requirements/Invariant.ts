...
export const Invariant = Requirement.extend({
    ...
    reqIdPrefix: z.literal('E.6.').prefault('E.6.'),
    reqType: z.enum(ReqType).prefault(ReqType.INVARIANT),
    uiBasePathTemplate: z.string().prefault(uiBasePathTemplates[ReqType.INVARIANT])
