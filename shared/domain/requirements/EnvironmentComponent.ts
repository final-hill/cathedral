...
export const EnvironmentComponent = Component.extend({
    ...
    reqIdPrefix: z.literal('E.2.').prefault('E.2.'),
    reqType: z.enum(ReqType).prefault(ReqType.ENVIRONMENT_COMPONENT),
    uiBasePathTemplate: z.string().prefault(uiBasePathTemplates[ReqType.ENVIRONMENT_COMPONENT])
