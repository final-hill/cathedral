...
export const Task = Requirement.extend({
    ...
    reqIdPrefix: z.literal('P.4.').prefault('P.4.'),
    reqType: z.enum(ReqType).prefault(ReqType.TASK),
    uiBasePathTemplate: z.string().prefault(uiBasePathTemplates[ReqType.TASK])
