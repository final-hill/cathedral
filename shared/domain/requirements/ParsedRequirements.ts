...
export const ParsedRequirements = MetaRequirement.extend({
    ...
    reqIdPrefix: z.literal('P.7.').prefault('P.7.'),
    workflowState: z.enum(WorkflowState).prefault(WorkflowState.Parsed),
    requirements: z.array(RequirementReference).prefault([])
